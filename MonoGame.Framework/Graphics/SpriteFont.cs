// MonoGame - Copyright (C) MonoGame Foundation, Inc This file is subject to the terms and conditions defined in file 'LICENSE.txt', which is part of
...
namespace Microsoft.Xna.Framework.Graphics 
{
    ...
    public sealed class SpriteFont 
    {
        ...
        /// <summary> All the glyphs in this SpriteFont. </summary>
        ...
        /// <summary> Gets the texture that this SpriteFont draws from. </summary>
        /// <remarks> Can be used to implement custom rendering of a SpriteFont </remarks>
        public Texture2D Texture { get { return _texture; } }

        /// <summary> Returns a copy of the dictionary containing the glyphs in this SpriteFont. </summary>
        ...
        /// <summary> Gets a collection of the characters in the font. </summary>
        public ReadOnlyCollection<char> Characters { get; private set; }

        /// <summary> Gets or sets the character that will be substituted when a given character is not included in the font. </summary>
        ...
        /// <summary> Gets or sets the line spacing (the distance from baseline to baseline) of the font. </summary>
        public int LineSpacing { get; set; }

        /// <summary> Gets or sets the spacing (tracking) between characters in the font. </summary>
        public float Spacing { get; set; }

        /// <summary> Returns the size of a string when rendered in this font. </summary>
        ...
        /// <summary> Run repeatedly to measure the size of a string up to a character. Initial values values specified in docs for params. </summary>
        ...
        internal unsafe void MeasureChar(char c, ref float width, ref float finalLineHeight, ref Vector2 offset, ref bool firstGlyphOfLine, Glyph* pGlyphs)
        {
            ...
            // The first character on a line might have a negative left side bearing. In this scenario, SpriteBatch/SpriteFont normally offset the
            // text to the right, so that text does not hang off the left side of its rectangle.
            if (firstGlyphOfLine)
            {
        ...
        /// <summary> Struct that defines the spacing, Kerning, and bounds of a character. </summary>
        /// <remarks> Provides the data necessary to implement custom SpriteFont rendering. </remarks>
        public struct Glyph
        {
            /// <summary> The char associated with this glyph. </summary>
            public char Character;
            /// <summary> Rectangle in the font texture where this letter exists. </summary>
            public Rectangle BoundsInTexture;
            /// <summary> Cropping applied to the BoundsInTexture to calculate the bounds of the actual character. </summary>
            public Rectangle Cropping;
            /// <summary> The amount of space between the left side of the character and its first pixel in the X dimension. </summary>
            public float LeftSideBearing;
            /// <summary> The amount of space between the right side of the character and its last pixel in the X dimension. </summary>
            public float RightSideBearing;
            /// <summary> Width of the character before kerning is applied. </summary>
            public float Width;
            /// <summary> Width of the character before kerning is applied. </summary>
            public float WidthIncludingBearings;

            /// <summary> Returns an empty glyph. </summary>
            public static readonly Glyph Empty = new();

            /// <summary> Returns a string representation of this <see cref="Glyph"/>. </summary>
